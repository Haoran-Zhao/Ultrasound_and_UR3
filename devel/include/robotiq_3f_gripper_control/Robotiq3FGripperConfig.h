...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.mode = 0;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(Robotiq3FGripperConfig::AbstractParamDescriptionConstPtr(new Robotiq3FGripperConfig::ParamDescription<int>("mode", "int", 0, "The grasping mode", "{'enum_description': 'An enum to set the grasp operation mode', 'enum': [{'srcline': 37, 'description': 'Basic mode', 'srcfile': '/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Basic'}, {'srcline': 38, 'description': 'Pinch mode', 'srcfile': '/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Pinch'}, {'srcline': 39, 'description': 'Wide mode', 'srcfile': '/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Wide'}, {'srcline': 40, 'description': 'Scissor mode', 'srcfile': '/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Scissor'}]}", &Robotiq3FGripperConfig::mode)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(Robotiq3FGripperConfig::AbstractParamDescriptionConstPtr(new Robotiq3FGripperConfig::ParamDescription<int>("mode", "int", 0, "The grasping mode", "{'enum_description': 'An enum to set the grasp operation mode', 'enum': [{'srcline': 37, 'description': 'Basic mode', 'srcfile': '/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Basic'}, {'srcline': 38, 'description': 'Pinch mode', 'srcfile': '/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Pinch'}, {'srcline': 39, 'description': 'Wide mode', 'srcfile': '/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Wide'}, {'srcline': 40, 'description': 'Scissor mode', 'srcfile': '/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Scissor'}]}", &Robotiq3FGripperConfig::mode)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 37 "/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
      const int Robotiq3FGripper_Basic = 0;
//#line 38 "/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
      const int Robotiq3FGripper_Pinch = 1;
//#line 39 "/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
      const int Robotiq3FGripper_Wide = 2;
//#line 40 "/home/haoran/UR_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
