...
if("TRUE" STREQUAL "TRUE")
  set(jog_msgs_SOURCE_PREFIX /home/haoran/UR_ws/src/jog_ur3/jog_msgs)
  set(jog_msgs_DEVEL_PREFIX /home/haoran/UR_ws/devel)
  set(jog_msgs_INSTALL_PREFIX "")
  set(jog_msgs_PREFIX ${jog_msgs_DEVEL_PREFIX})
else()
  set(jog_msgs_SOURCE_PREFIX "")
  set(jog_msgs_DEVEL_PREFIX "")
  set(jog_msgs_INSTALL_PREFIX /home/haoran/UR_ws/install)
...
if(NOT "/home/haoran/UR_ws/devel/include " STREQUAL " ")
  set(jog_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/haoran/UR_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'jog_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haoran/UR_ws/src/jog_ur3/jog_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT jog_msgs_NUM_DUMMY_TARGETS)
      set(jog_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::jog_msgs::wrapped-linker-option${jog_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR jog_msgs_NUM_DUMMY_TARGETS "${jog_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::jog_msgs::wrapped-linker-option${jog_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND jog_msgs_LIBRARIES "${interface_target_name}")
