...
echo_and_run cd "/home/haoran/UR_ws/src/ros_controllers/rqt_joint_trajectory_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haoran/UR_ws/src/ros_controllers/rqt_joint_trajectory_controller/setup.py" \
     \
    build --build-base "/home/haoran/UR_ws/build/ros_controllers/rqt_joint_trajectory_controller" \
    install \
    --root="${DESTDIR-/}" \
