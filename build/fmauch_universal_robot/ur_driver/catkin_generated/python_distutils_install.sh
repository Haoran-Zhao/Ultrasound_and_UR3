...
echo_and_run cd "/home/haoran/UR_ws/src/fmauch_universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haoran/UR_ws/src/fmauch_universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/home/haoran/UR_ws/build/fmauch_universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
