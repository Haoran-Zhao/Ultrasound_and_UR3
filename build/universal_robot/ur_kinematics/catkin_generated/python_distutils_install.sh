...
echo_and_run cd "/home/haoran/UR_ws/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haoran/UR_ws/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/haoran/UR_ws/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
