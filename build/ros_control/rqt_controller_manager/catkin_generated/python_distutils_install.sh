...
echo_and_run cd "/home/haoran/UR_ws/src/ros_control/rqt_controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haoran/UR_ws/src/ros_control/rqt_controller_manager/setup.py" \
     \
    build --build-base "/home/haoran/UR_ws/build/ros_control/rqt_controller_manager" \
    install \
    --root="${DESTDIR-/}" \
