...
echo_and_run cd "/home/haoran/UR_ws/src/ros_control/controller_manager_tests"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haoran/UR_ws/src/ros_control/controller_manager_tests/setup.py" \
     \
    build --build-base "/home/haoran/UR_ws/build/ros_control/controller_manager_tests" \
    install \
    --root="${DESTDIR-/}" \
