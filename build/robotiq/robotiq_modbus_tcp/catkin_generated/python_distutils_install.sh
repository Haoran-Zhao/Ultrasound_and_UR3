...
echo_and_run cd "/home/haoran/UR_ws/src/robotiq/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haoran/UR_ws/src/robotiq/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/haoran/UR_ws/build/robotiq/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
