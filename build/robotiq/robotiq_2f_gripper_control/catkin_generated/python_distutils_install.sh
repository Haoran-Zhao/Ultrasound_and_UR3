...
echo_and_run cd "/home/haoran/UR_ws/src/robotiq/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haoran/UR_ws/src/robotiq/robotiq_2f_gripper_control/setup.py" \
     \
    build --build-base "/home/haoran/UR_ws/build/robotiq/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
